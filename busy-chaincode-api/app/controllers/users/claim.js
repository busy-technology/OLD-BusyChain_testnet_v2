      ...
      if (user) {
        ...
        if (resp.success == true) {
          ...
          await transactionEntry
            .save()
            .then((result, error) => {
              console.log("Claim transaction recorded.");
            })
            .catch((error) => {
          ...
          return res.send(200, {
            status: true,
            message: "Request to claim staking reward has been successfully accepted",
        ...
        console.log("User having this staking address not found.");
        return res.send(404, {
          status: false,
